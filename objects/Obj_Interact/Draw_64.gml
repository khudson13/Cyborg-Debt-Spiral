...
for (var i = 0; i == 0 || i < itemCount ; ++i;){
	...
	draw_text(0,display_y + display_height,Obj_Items_Master.ItemsMaster[items[i].ItemID][itemstats.name]);
	menuCount += 1;
...
for (var i = 0; i == 0 || i < npcCount ; ++i;){
	...
	draw_text(0,display_y + display_height,npc[i].NPC_name);
	menuCount += 1;
...
for (var i = 0; i == 0 || i < furnitureCount ; ++i;){
	...
	draw_text(0,display_y + display_height,furniture[i].name);
	menuCount += 1;
